...
The 'flight_tracking_system' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/flight_tracking_system/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] flight_tracking_system_etl` to your workspace.
